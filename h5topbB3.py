'''
YPL & JLL, 2021.9.17, 10.12

Run train_modelB3.py => ./saved_model/opUNetPNB3.h5 =>
(YPN) jinn@Liu:~/YPN/OPNet$ python h5topbB3.py opUNetPNB3.pb
=> ./saved_model/opUNetPNB3.pb => Done
'''
import os
import argparse
...
def h5_to_pb(pb_save_name):
  try:
    ...
    model.load_weights('./saved_model/opUNetPNB3.h5')
    model.summary()
  except ValueError:
