...
???
  all_images.append consumes huge memory
  #---datagenA4  all_images.append count = 1008
  File "/home/jinn/YPN/OPNet/datagenA4.py", line 43, in concatenate
...
def concatenate(images, masks, mask_H, mask_W, class_values):
    ...
    for img, msk in zip(images, masks):
        if os.path.isfile(img) and os.path.isfile(msk):
            ...
            count += 1
            print('#---datagenA4  all_images.append count =', count)
              #---datagenA4  all_images.append count = 1008
            #print('#---datagenA4  msk =', msk)
        else:
